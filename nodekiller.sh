...
clear
echo -e "${CYAN}=============================================================================================${NC}"
echo -e "${CYAN}                               NODE KILLER v0.0.1                                            ${NC}"
echo -e "${CYAN}=============================================================================================${NC}"
echo  ""

mapfile -t venvs < <(find . -type d \( -name "node_modules" \) -print)
states=()
sizes=()
...
if [ ${#venvs[@]} -eq 0 ]; then
    echo -e "${RED}No node_modules found.${NC}"
    exit 0
fi
...
while true; do
    ...
    read -p "Enter the number of the node_modules to delete: " choice
